(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DbOperationService = /** @class */ (function () {
                function DbOperationService(http) {
                    this.http = http;
            ...
            DbOperationService.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LoginComponent = /** @class */ (function () {
                function LoginComponent(router, dbServ, cookieService) {
                    this.router = router;
                    this.dbServ = dbServ;
                    this.cookieService = cookieService;
                ...
                LoginComponent.prototype.onLoginSubmit = function () {
                    ...
                    this.dbServ.loginUser(this.userLogin).subscribe(function (data) {
                        console.log(data);
                        _this.message = data["success"];
                        console.log(_this.message);
                        if (_this.message == "no") {
                            _this.isnotvalid = true;
                            console.log('Error is there');
                        }
                        else {
                            _this.cookieService.set('user', data["email"]);
                            var cookieExists = _this.cookieService.check('user');
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MainHomeComponent = /** @class */ (function () {
                function MainHomeComponent(router) {
                    this.router = router;
                }
                MainHomeComponent.prototype.ngOnInit = function () {
                };
                MainHomeComponent.prototype.onLogin = function () {
                    console.log('Transferring to login');
                    this.router.navigate(['/login']);
                };
                MainHomeComponent.prototype.onSignin = function () {
                    this.router.navigate(['/register']);
                };
                return MainHomeComponent;
            }());
            MainHomeComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ManageUserComponent = /** @class */ (function () {
                function ManageUserComponent(router, dbServ, cookieService) {
                    this.router = router;
                    this.dbServ = dbServ;
                    this.cookieService = cookieService;
                    this.exists = false;
                ...
                ManageUserComponent.prototype.check = function () {
                ...
                Object.defineProperty(ManageUserComponent.prototype, "first_name", {
                    get: function () { return this.updateForm.get('first_name'); },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(ManageUserComponent.prototype, "last_name", {
                    get: function () { return this.updateForm.get('last_name'); },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(ManageUserComponent.prototype, "email", {
                    get: function () { return this.updateForm.get('email'); },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(ManageUserComponent.prototype, "password", {
                    get: function () { return this.updateForm.get('password'); },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(ManageUserComponent.prototype, "confirm_password", {
                    get: function () { return this.updateForm.get('confirm_password'); },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(ManageUserComponent.prototype, "contact_num", {
                    get: function () { return this.updateForm.get('contact_num'); },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(ManageUserComponent.prototype, "address1", {
                    // get passcheck() { return this.updateForm.get('password')===this.updateForm.get('confirm_password')?null : {notSame:true}}
                    get: function () { return this.updateForm.get('address1'); },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(ManageUserComponent.prototype, "landmark", {
                    get: function () { return this.updateForm.get('landmark'); },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(ManageUserComponent.prototype, "area", {
                    get: function () { return this.updateForm.get('area'); },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(ManageUserComponent.prototype, "city", {
                    get: function () { return this.updateForm.get('city'); },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(ManageUserComponent.prototype, "state", {
                    get: function () { return this.updateForm.get('state'); },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(ManageUserComponent.prototype, "pincode", {
                    get: function () { return this.updateForm.get('pincode'); },
                    enumerable: true,
                    configurable: true
                });
                ManageUserComponent.prototype.ngOnInit = function () {
                    ...
                    this.dbServ.UserHome(this.cookieService.get('user')).subscribe(function (data) {
                        console.log(data);
                        _this.userDetails = new _model_userLogin__WEBPACK_IMPORTED_MODULE_4__["UserDetails"](data.email, data.password, data.firstName, data.lastName, data.contactNumber, data.addresses);
                        console.log(_this.userDetails);
                        _this.check();
                    });
                };
                ManageUserComponent.prototype.onUpdate = function () {
                    var _this = this;
                    ...
                    this.dbServ.UpdateUser(this.userData).subscribe(function (data) {
                        _this.message = data["message"];
                        if (_this.message != "Failure") {
                            _this.exists = true;
                        }
                        else {
                            _this.exists = false;
                ...
                ManageUserComponent.prototype.onBack = function () {
                    this.router.navigate(['userHome']);
                };
                ManageUserComponent.prototype.onDelete = function () {
                    alert("sure You Want To Delete Your Account??");
                    this.dbServ.DeleteUser(this.cookieService.get('user')).subscribe(function (data) { return data; });
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UserLogin = /** @class */ (function () {
                function UserLogin(email, password, msg) {
                    this.email = email;
            ...
            var Address = /** @class */ (function () {
                function Address(address1, landmark, area, city, state, pincode, type) {
            ...
            var UserDetails = /** @class */ (function () {
                //msg:string
                function UserDetails(email, password, firstName, lastName, contactNumber, addresses) {
                    this.email = email;
                    this.password = password;
            ...
            var Menu = /** @class */ (function () {
                function Menu(itemName, itemType, foodType, price) {
            ...
            var HotelDetails = /** @class */ (function () {
                function HotelDetails(hotelId, hotelName, hotelEmail, hotelContactNo, address, city, state, pincode, menu) {
                    this._id = hotelId;
            ...
            var Item = /** @class */ (function () {
                function Item(itemName, itemType, foodType, price, quantity) {
                    this.itemName = itemName;
                    this.itemType = itemType;
                    this.foodType = foodType;
                    this.price = price;
            ...
            var OrderDetails = /** @class */ (function () {
                function OrderDetails(orderDate, hotelName, hotelEmail, userEmail, totalAmount, status, paymentMode, netItems, items) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var RegistrationComponent = /** @class */ (function () {
                function RegistrationComponent(router, dbServ) {
                    this.router = router;
                    this.dbServ = dbServ;
                    this.exists = false;
                    this.message = '';
                ...
                Object.defineProperty(RegistrationComponent.prototype, "first_name", {
                    get: function () { return this.signinForm.get('first_name'); },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(RegistrationComponent.prototype, "last_name", {
                    get: function () { return this.signinForm.get('last_name'); },
                    enumerable: true,
                    configurable: true
                });
                ...
                Object.defineProperty(RegistrationComponent.prototype, "confirm_password", {
                    get: function () { return this.signinForm.get('confirm_password'); },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(RegistrationComponent.prototype, "contact_num", {
                    get: function () { return this.signinForm.get('contact_num'); },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(RegistrationComponent.prototype, "address1", {
                    // get passcheck() { return this.signinForm.get('password')===this.signinForm.get('confirm_password')?null : {notSame:true}}
                    get: function () { return this.signinForm.get('address1'); },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(RegistrationComponent.prototype, "landmark", {
                    get: function () { return this.signinForm.get('landmark'); },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(RegistrationComponent.prototype, "area", {
                    get: function () { return this.signinForm.get('area'); },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(RegistrationComponent.prototype, "city", {
                    get: function () { return this.signinForm.get('city'); },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(RegistrationComponent.prototype, "state", {
                    get: function () { return this.signinForm.get('state'); },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(RegistrationComponent.prototype, "pincode", {
                    get: function () { return this.signinForm.get('pincode'); },
                    enumerable: true,
                    configurable: true
                });
                RegistrationComponent.prototype.ngOnInit = function () {
                };
                RegistrationComponent.prototype.onSignin = function () {
                    var _this = this;
                    ...
                    console.log(this.userData);
                    this.dbServ.registerUser(this.userData).subscribe(function (data) {
                        _this.message = data["message"];
                        if (_this.message != "exists") {
                            _this.exists = false;
                ...
                RegistrationComponent.prototype.onLoginClick = function () {
                    this.router.navigate(['login']);
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UserHomeComponent = /** @class */ (function () {
                function UserHomeComponent(dbServ, cookieService, router) {
                    this.dbServ = dbServ;
                    this.cookieService = cookieService;
                    this.router = router;
                }
                UserHomeComponent.prototype.ngOnInit = function () {
                    ...
                    if (this.cookieService.get('user')) {
                        this.dbServ.UserHome(this.cookieService.get('user')).subscribe(function (data) {
                            console.log(data);
                            _this.userDetails = new _model_userLogin__WEBPACK_IMPORTED_MODULE_3__["UserDetails"](data.email, data.password, data.firstName, data.lastName, data.contactNumber, data.addresses);
                            console.log(_this.userDetails);
                            _this.userName = _this.userDetails['firstName'];
                        });
                    }
                    else {
                        this.router.navigate(['login']);
                ...
                UserHomeComponent.prototype.setHotels = function (hotels) {
                    this.hotels = hotels;
                };
                UserHomeComponent.prototype.onManageClick = function () {
                    this.router.navigate(['manageUser']);
                };
                UserHomeComponent.prototype.changeInCity = function (newValue) {
                    var _this = this;
                    this.isOrdered = false;
                    this.isOnMenu = true;
                    ...
                    if (cityname != "Select City") {
                        ...
                        this.hotelSelected = false;
                        this.dbServ.showHotelDetails(cityname).subscribe(function (data) {
                ...
                UserHomeComponent.prototype.onHotelClick = function (newValue) {
                    this.isOnMenu = false;
                ...
                UserHomeComponent.prototype.onMinus = function (newValue) {
                    var k;
                    var count = 0;
                ...
                UserHomeComponent.prototype.onPlus = function (newValue) {
                ...
                UserHomeComponent.prototype.onMakePayment = function () {
                    this.isOrdered = true;
                    var today = new Date();
                ...
                UserHomeComponent.prototype.placeOrder = function () {
                    var _this = this;
                    this.dbServ.orderPlace(this.orderDetails).subscribe(function (data) {
                        console.log(data);
                        ...
                        if (message == "Success") {
                            ...
                            _this.selectedCity = false;
                            _this.hotelSelected = false;
                        }
                    });
                };
                UserHomeComponent.prototype.goToHotels = function () {
                    this.isOrdered = false;
                    this.hotelSelected = false;
                    this.isItemSelected = false;
                    this.selectedCity = true;
